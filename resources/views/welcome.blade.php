...
<body class="antialiased">
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex align-items-center">
            ...
            <div id="logo" class="me-auto">
                <a href="index.html"><img src="dark_2x.png" alt=""></a>
    ...
    <section id="hero" class="hero">
        <div class="container text-center">
            <div class="row">
                <div class="col-md-12">
                    <a class="hero-brand" href="index.html" title="Yancom Creation"><img alt="Yancom Creation"
                            style="background:#cbd5e0" src="dark_2x.png"></a>
                </div>
            </div>
